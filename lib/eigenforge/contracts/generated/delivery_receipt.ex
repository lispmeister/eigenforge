defmodule Eigenforge.Contracts.DeliveryReceipt do
  ...
  @fields [:command_id, :decision_event_id, :delivered_at, :delivered_topic, :format_version, :ledger_event_hash, :ledger_sequence, :receipt_id, :schema_id, :schema_version, :signature, :signature_version]
  @required_fields [:format_version, :schema_id, :schema_version, :receipt_id, :command_id, :decision_event_id, :ledger_sequence, :ledger_event_hash, :delivered_topic, :delivered_at, :signature_version, :signature]
  @field_types [command_id: :string, decision_event_id: :string, delivered_at: :string, delivered_topic: :string, format_version: :string, ledger_event_hash: :string, ledger_sequence: :integer, receipt_id: :string, schema_id: :string, schema_version: :integer, signature: :string, signature_version: :string]
