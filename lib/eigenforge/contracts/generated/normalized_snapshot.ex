defmodule Eigenforge.Contracts.NormalizedSnapshot do
  ...
  @fields [:co2_ppm, :fan_state, :format_version, :freshness, :humidity_percent, :normalized_at, :room_id, :schema_id, :schema_version, :snapshot_hash, :snapshot_id, :snapshot_seq, :source_entity_ids, :source_observed_at, :source_status, :temperature_c]
  @required_fields [:format_version, :schema_id, :schema_version, :snapshot_id, :snapshot_seq, :snapshot_hash, :room_id, :source_entity_ids, :source_observed_at, :source_status, :normalized_at, :freshness]
  @field_types [co2_ppm: :integer, fan_state: :string, format_version: :string, freshness: :string, humidity_percent: :integer, normalized_at: :string, room_id: :string, schema_id: :string, schema_version: :integer, snapshot_hash: :string, snapshot_id: :string, snapshot_seq: :integer, source_entity_ids: :object, source_observed_at: :object, source_status: :object, temperature_c: :integer]
